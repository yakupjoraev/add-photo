...
bindModal('.modal__btn-location', '.modal__wrapper-location', '.modal__close-location')
bindModal('.modal__btn-certificate', '.modal__wrapper-certificate', '.modal__close-certificate')
...
const text = document.querySelector('.ideas__text');
